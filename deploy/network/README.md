...
| 线路 id | 展示名 | 节点 | 公网 IP | frps bindPort | 入口端口 | frpc 管理端口 | PROXY v2 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `hz1` | 杭州一线 | 阿里云ECS-杭州1 | 47.118.28.70 | 7000 | 25601 | 7401 | 开 |
| `sz` | 深圳线 | 阿里云ECS-深圳1 | 120.24.184.115 | 7000 | 25602 | 7402 | 开 |
| `home` | 家宽直连 | 家庭宽带 | 175.44.0.36（动态） | 不经 frp | 25603 | 无 | **关** |
| `wh` | 武汉线 | 阿里云轻量-武汉1 | 47.122.120.140 | 7000 | 25604 | 7404 | 开 |
| `gz` | 广州线 | 阿里云轻量-广州1 | 8.148.217.146 | **48124** | 25605 | 7405 | 开 |
| `hz2` | 杭州二线 | 阿里云轻量-杭州1 | 47.114.79.114 | 7000 | 25606 | 7406 | 开 |
| `sh` | 上海线 | 阿里云ECS-上海1 | 101.133.234.218 | 7000 | 25607 | 7407 | 开 |
...
| --- | --- | --- | --- | --- | --- |
| `hz1` | A | 默认 | 47.118.28.70 | 600 | 杭州一线，玩家填 `hz1.mcwok.cn` |
| `sz` | A | 默认 | 120.24.184.115 | 600 | 深圳线，玩家填 `sz.mcwok.cn` |
| `wh` | A | 默认 | 47.122.120.140 | 600 | 武汉线 |
| `gz` | A | 默认 | 8.148.217.146 | 600 | 广州线 |
| `hz2` | A | 默认 | 47.114.79.114 | 600 | 杭州二线 |
| `sh` | A | 默认 | 101.133.234.218 | 600 | 上海线 |
...
七条 A 记录都指向标准的 25565 端口，玩家只填域名、不填端口即可。
